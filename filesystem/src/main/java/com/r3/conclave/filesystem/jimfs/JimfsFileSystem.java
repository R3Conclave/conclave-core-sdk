 ...
 *
 * {@link JimfsFileSystem JimfsFileSystem} instances are created by
 * {@link JimfsFileSystems JimfsFileSystems} using a user-provided
 * {@link Configuration Configuration}. The configuration is used to create
 ...
 * {@link JimfsFileSystemProvider JimfsFileSystemProvider}, which handles
 * calls to methods in {@link java.nio.file.Files}, and
 * {@link JimfsSecureDirectoryStream JimfsSecureDirectoryStream}, which
 ...
 * {@link FileSystemView FileSystemView} class, which acts as a view of
 ...
 * {@link JimfsFileStore JimfsFileStore} which handles file creation,
 * storage and attributes. The file store delegates to several other classes to handle each of
 * these:
 *
 * <ul>
 *   <li>{@link FileFactory FileFactory} handles creation of new file
 *   objects.</li>
 *   <li>{@link HeapDisk HeapDisk} handles allocation of blocks to
 *   {@link RegularFile RegularFile} instances.</li>
 *   <li>{@link FileTree FileTree} stores the root of the file hierarchy
 *   and handles file lookup.</li>
 *   <li>{@link AttributeService AttributeService} handles file
 *   attributes, using a set of
 *   {@link AttributeProvider AttributeProvider} implementations to
 ...
 * {@link JimfsPath JimfsPath}. Paths are created by a
 * {@link PathService PathService} with help from the file system's
 * configured {@link PathType PathType}.
 *
 * <p>Paths are made up of {@link Name Name} objects, which also serve as
 ...
 * <h3>Files</h3>
 *
 * All files in the file system are an instance of {@link File File}. A
 ...
 *   to {@linkplain DirectoryEntry directory entries}.
 *   <li>{@link RegularFile RegularFile} - an in-memory store for raw bytes.
 *   <li>{@link SymbolicLink SymbolicLink} - contains a path.
 * </ul>
 *
 * <p>{@link JimfsFileChannel JimfsFileChannel},
 * {@link JimfsInputStream JimfsInputStream} and
 * {@link JimfsOutputStream JimfsOutputStream} implement the standard
 * channel/stream APIs for regular files.
 *
 * <p>{@link JimfsSecureDirectoryStream JimfsSecureDirectoryStream} handles
 ...
 * implementation, {@link PollingWatchService PollingWatchService}.
 *
 * <h3>Regular files</h3>
 *
 * {@link RegularFile RegularFile} makes use of a singleton
 * {@link HeapDisk HeapDisk}. A disk is a resizable factory and cache for
