...
import com.r3.conclave.jvmtester.api.proto.ExecuteTest
...
//            enclaveHandle.destroy()
        ...
        fun setUp() {
            enclaveHandle = if (sgxMode.toUpperCase() == "MOCK") {
                ...
                hostApi.createEnclave(RootHandler(), File(enclavePath), "com.r3.conclave.jvmtester.testenclave.TestEnclave")
            }
