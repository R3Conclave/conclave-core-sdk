...
import com.r3.conclave.jvmtester.testenclave.handlers.TestHandler
import com.r3.conclave.jvmtester.testenclave.handlers.TestRunner
import com.r3.conclave.jvmtester.testenclave.messages.MessageType
import com.r3.conclave.jvmtester.api.proto.*
...
class TestEnclave : Enclavelet() {
    ...
    class EnclaveHandler : Handler<EnclaveConnection> {
        ...
        companion object {
            private fun processJar(connection: EnclaveConnection, input: ByteBuffer) {
             ...
             */
            private fun generateByteCode(connection: EnclaveConnection, input: ByteBuffer, testHandler: TestHandler) {
                testHandler.setup(connection)
