...
object SerializationUtils {
    ...
    fun serializeIntArray(data: Any?): ByteString {
        ...
        return com.r3.conclave.jvmtester.djvm.proto.IntArray.newBuilder().addAllValues(output.asIterable()).build().toByteString()
    }
    ...
    fun serializeDoubleArray(data: Any?): ByteString {
        val output = data as Array<*>
        val builder = com.r3.conclave.jvmtester.djvm.proto.DoubleArray.newBuilder()
        output.forEach {
