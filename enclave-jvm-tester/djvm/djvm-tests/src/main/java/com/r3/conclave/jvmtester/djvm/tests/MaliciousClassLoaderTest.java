...
public class MaliciousClassLoaderTest {
    ...
    public static class TestWithAnEvilClassLoaderEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.jvmtester.djvm.asserters.MaliciousClassLoaderTest.TestWithAnEvilClassLoader().assertResult(testResult);
        }
    }
    ...
    public static class TestWithEvilParentClassLoaderEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.jvmtester.djvm.asserters.MaliciousClassLoaderTest.TestWithEvilParentClassLoader().assertResult(testResult);
        }
    }
    ...
    public static class TestAccessingParentClassLoaderEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.jvmtester.djvm.asserters.MaliciousClassLoaderTest.TestAccessingParentClassLoader().assertResult(testResult);
        }
    }
    ...
    public static class TestClassLoaderForWhitelistedClassEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.jvmtester.djvm.asserters.MaliciousClassLoaderTest.TestClassLoaderForWhitelistedClass().assertResult(testResult);
        }
    }
