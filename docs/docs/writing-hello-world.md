...
!!! note
    ...
    enclave environment supports Java 16 by default!
...
!!! note
    ...
    A Curve25519 private key is simply 32 random bytes, which you can access using the getEncoded() method on PrivateKey.
