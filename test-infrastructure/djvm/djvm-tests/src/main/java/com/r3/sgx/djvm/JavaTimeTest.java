...
public class JavaTimeTest extends DJVMBase {
    ...
    public static class InstantTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
            ...
            sandbox(ctx -> {
                try {
                    ...
                    Class<Function<Object, String>> temporalToStringClass =
                            (Class<Function<Object, String>>) loadClass(ctx, "com.r3.sgx.djvm.auxiliary.JavaTimeTest$TemporalToString")
                                    .getType();
                    ...
                    Class<Function<Object, Object>> identityTransformationClass =
                            (Class<Function<Object, Object>>) loadClass(ctx, "com.r3.sgx.djvm.auxiliary.JavaTimeTest$IdentityTransformation")
                                    .getType();
        ...
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.InstantTest().assertResult(testResult);
        }
    }
    ...
    public static class DurationTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.DurationTest().assertResult(testResult);
        }
    }
    ...
    public static class LocalDateTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.LocalDateTest().assertResult(testResult);
        }
    }
    ...
    public static class LocalTimeTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.LocalTimeTest().assertResult(testResult);
        }
    }
    ...
    public static class LocalDateTimeTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.LocalDateTimeTest().assertResult(testResult);
        }
    }
    ...
    public static class MonthDayTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.MonthDayTest().assertResult(testResult);
        }
    }
    ...
    public static class OffsetDateTimeTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.OffsetDateTimeTest().assertResult(testResult);
        }
    }
    ...
    public static class OffsetTimeTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.OffsetTimeTest().assertResult(testResult);
        }
    }
    ...
    public static class PeriodTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.PeriodTest().assertResult(testResult);
        }
    }
    ...
    public static class YearTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.YearTest().assertResult(testResult);
        }
    }
    ...
    public static class YearMonthTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.YearMonthTest().assertResult(testResult);
        }
    }
    ...
    public static class ZonedDateTimeTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.ZonedDateTimeTest().assertResult(testResult);
        }
    }
    ...
    public static class ZoneOffsetTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.ZoneOffsetTest().assertResult(testResult);
        }
    }
    ...
    public static class AllZoneIDsTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
            ...
            sandbox(ctx -> {
                try {
                    ...
                    Class<Function<Object, String[]>> allZoneIDsClass
                            = (Class<Function<Object, String[]>>) loadClass(ctx, "com.r3.sgx.djvm.auxiliary.JavaTimeTest$AllZoneIDs")
                            .getType();
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.AllZoneIDsTest().assertResult(testResult);
        }
    }
    ...
    public static class DefaultZoneIDTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
            ...
            sandbox(ctx -> {
                try {
                    ...
                    Class<? extends Function<Object, String>> defaultZoneIDClass =
                            (Class<? extends Function<Object, String>>) loadClass(ctx, "com.r3.sgx.djvm.auxiliary.JavaTimeTest$DefaultZoneId")
                                    .getType();
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.DefaultZoneIDTest().assertResult(testResult);
        }
    }
    ...
    public static class DefaultTimeZoneTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
            ...
            sandbox(ctx -> {
                try {
                    ...
                    Class<Function<Date, String>> defaultTimeZoneClass =
                            (Class<Function<Date, String>>) loadClass(ctx, "com.r3.sgx.djvm.auxiliary.JavaTimeTest$DefaultTimeZone")
                                    .getType();
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.DefaultTimeZoneTest().assertResult(testResult);
        }
    }
    ...
    public static class DateTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
            ...
            sandbox(ctx -> {
                try {
                    ...
                    Class<Function<Date, String>> showDateClass =
                            (Class<Function<Date, String>>) loadClass(ctx, "com.r3.sgx.djvm.auxiliary.JavaTimeTest$ShowDate")
                                    .getType();
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.DateTest().assertResult(testResult);
        }
    }
    ...
    public static class ReturningDateTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
            ...
            sandbox(ctx -> {
                try {
                    ...
                    Class<Function<Date, Date>> addToDateClass =
                            (Class<Function<Date, Date>>) loadClass(ctx, "com.r3.sgx.djvm.auxiliary.JavaTimeTest$AddToDate")
                                    .getType();
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.JavaTimeTest.ReturningDateTest().assertResult(testResult);
        }
    }
}
