...
public class SandboxThrowableJavaTest {
    ...
    public static class TestUserExceptionHandlingEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxThrowableJavaTest.TestUserExceptionHandling().assertResult(testResult);
        }
    }
    ...
    public static class TestCheckedExceptionsEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxThrowableJavaTest.TestCheckedExceptions().assertResult(testResult);
        }
    }
    ...
    public static class TestMultiCatchExceptionsEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public Object apply(Object input) {
            ...
            sandbox(ctx -> {
                ...
                ArrayList<String> outputs = new ArrayList<>();
                {
                    ...
                    assertThat(result).isEqualTo("sandbox.com.r3.sgx.djvm.MyExampleException:1");
                    outputs.add(result);
                }
                {
                    ...
                    outputs.add(result);
                    assertThat(result).isEqualTo("sandbox.com.r3.sgx.djvm.MyOtherException:2");
                }
                {
                    ...
                    assertThat(exception)
                            ...
                            .hasMessage("sandbox.com.r3.sgx.djvm.BigTroubleException -> 3")
                            .hasCauseExactlyInstanceOf(Exception.class);
                    assertThat(exception.getCause())
                            .hasMessage("sandbox.com.r3.sgx.djvm.MyBaseException -> sandbox.com.r3.sgx.djvm.BigTroubleException=3");
                ...
                }
                {
                    ...
                    assertThat(exception)
                            ...
                            .hasCauseExactlyInstanceOf(Exception.class);
                    assertThat(exception.getCause())
                            .hasMessage("sandbox.com.r3.sgx.djvm.MyBaseException -> sandbox.java.lang.IllegalArgumentException=4");
                    outputs.add(exception.getMessage());
                }
                {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxThrowableJavaTest.TestMultiCatchExceptions().assertResult(testResult);
        }
    }
    ...
    public static class TestMultiCatchWithDisallowedExceptionsEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public Object apply(Object input) {
            ...
            sandbox(ctx -> {
                try {
                    ...
                    assertThat(success.getResult()).isEqualTo("sandbox.com.r3.sgx.djvm.MyExampleException:Hello World!");
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxThrowableJavaTest.TestMultiCatchWithDisallowedExceptions().assertResult(testResult);
        }
    }
    ...
    public static class TestSuppressedJvmExceptionsEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxThrowableJavaTest.TestSuppressedJvmExceptions().assertResult(testResult);
        }
    }
    ...
    public static class TestSuppressedUserExceptionsEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public Object apply(Object input) {
            ...
            sandbox(ctx -> {
                ...
                assertThat(exception)
                        ...
                        .hasCauseExactlyInstanceOf(Exception.class);
                assertThat(exception.getCause())
                        .hasMessage("sandbox.com.r3.sgx.djvm.MyExampleException -> THROW: Hello World!");
                assertThat(exception.getCause().getSuppressed())
                        .hasSize(1)
                        .allMatch(t -> t instanceof RuntimeException
                                && t.getMessage().equals("sandbox.com.r3.sgx.djvm.BigTroubleException -> BadResource: Hello World!"));
                output.set(new String[] {
                        exception.getMessage(), exception.getCause().getMessage(), exception.getCause().getSuppressed()[0].getMessage()
                });
                return null;
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxThrowableJavaTest.TestSuppressedUserExceptions().assertResult(testResult);
        }
    }
