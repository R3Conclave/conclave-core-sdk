...
public class SandboxStrictMathTest {
    public static class TestStrictMathHasNoRandomEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxStrictMathTest.TestStrictMathHasNoRandom().assertResult(testResult);
        }
    }
    ...
    public static class TestStrictMathHasTrigonometryEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxStrictMathTest.TestStrictMathHasTrigonometry().assertResult(testResult);
        }
    }
    ...
    public static class TestStrictMathRootsEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxStrictMathTest.TestStrictMathRoots().assertResult(testResult);
        }
    }
    ...
    public static class TestStrictMaxMinEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxStrictMathTest.TestStrictMaxMin().assertResult(testResult);
        }
    }
    ...
    public static class TestStrictAbsoluteEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxStrictMathTest.TestStrictAbsolute().assertResult(testResult);
        }
    }
    ...
    public static class TestStrictRoundEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxStrictMathTest.TestStrictRound().assertResult(testResult);
        }
    }
    ...
    public static class TestStrictExponentsEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxStrictMathTest.TestStrictExponents().assertResult(testResult);
        }
    }
    ...
    public static class TestStrictAnglesEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxStrictMathTest.TestStrictAngles().assertResult(testResult);
        }
    }
    ...
    public static class TestStrictHyperbolicsEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxStrictMathTest.TestStrictHyperbolics().assertResult(testResult);
        }
    }
    ...
    public static class TestStrictRemainderEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.SandboxStrictMathTest.TestStrictRemainder().assertResult(testResult);
        }
    }
