...
public class MaliciousClassTest {
    ...
    public static class TestImplementingToDJVMStringEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.MaliciousClassTest.TestImplementingToDJVMString().assertResult(testResult);
        }
    }
    ...
    public static class TestImplementingFromDJVMEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.MaliciousClassTest.TestImplementingFromDJVM().assertResult(testResult);
        }
    }
    ...
    public static class TestPassingClassIntoSandboxIsForbiddenEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.MaliciousClassTest.TestPassingClassIntoSandboxIsForbidden().assertResult(testResult);
        }
    }
    ...
    public static class TestPassingConstructorIntoSandboxIsForbiddenEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.MaliciousClassTest.TestPassingConstructorIntoSandboxIsForbidden().assertResult(testResult);
        }
    }
    ...
    public static class TestPassingClassLoaderIntoSandboxIsForbiddenEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.sgx.djvm.asserters.MaliciousClassTest.TestPassingClassLoaderIntoSandboxIsForbidden().assertResult(testResult);
        }
    }
...
//        @Override
//        public void assertResult(@NotNull byte[] testResult) {
//            new com.r3.sgx.djvm.asserters.MaliciousClassTest.TestCannotInvokeSandboxMethodsExplicitly.assertResult(testResult);
//        }
//    }
//
