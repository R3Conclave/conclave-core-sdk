...
class AnnotatedJavaClassTest {
    ...
    class SandboxAnnotationTest : TestAsserter {
        override fun assertResult(testResult: ByteArray) {
            ...
            assertThat(result).
                    isEqualTo("@sandbox.com.r3.conclave.integrationtests.djvm.sandboxtests.util.JavaAnnotation(value=Hello Java!)")
        }
    }
    ...
    class AnnotationInsideSandboxTest : TestAsserter {
        override fun assertResult(testResult: ByteArray) {
            val result = String(testResult)
            assertThat(result).isEqualTo("@sandbox.com.r3.conclave.integrationtests.djvm.sandboxtests.util.JavaAnnotation(value=Hello Java!)")
        }
    }
