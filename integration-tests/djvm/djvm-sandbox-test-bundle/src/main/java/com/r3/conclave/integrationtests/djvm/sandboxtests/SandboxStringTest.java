...
public class SandboxStringTest {
    ...
    public static class TestJoiningIterableInsideSandboxEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.SandboxStringTest.TestJoiningIterableInsideSandbox().assertResult(testResult);
        }
    }
    ...
    public static class TestJoiningVarargInsideSandboxEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.SandboxStringTest.TestJoiningVarargInsideSandbox().assertResult(testResult);
        }
    }
    ...
    public static class TestStringConstantEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.SandboxStringTest.TestStringConstant().assertResult(testResult);
        }
    }
    ...
    public static class EncodeStringWithUnknownCharsetEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.SandboxStringTest.EncodeStringWithUnknownCharset().assertResult(testResult);
        }
    }
    ...
    public static class DecodeStringWithCharsetEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.SandboxStringTest.DecodeStringWithCharset().assertResult(testResult);
        }
    }
    ...
    public static class TestCaseInsensitiveComparisonEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.SandboxStringTest.TestCaseInsensitiveComparison().assertResult(testResult);
        }
    }
    ...
    public static class TestStreamEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.SandboxStringTest.TestStream().assertResult(testResult);
        }
    }
    ...
    public static class TestSortingEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.SandboxStringTest.TestSorting().assertResult(testResult);
        }
    }
    ...
    public static class TestComplexStreamEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.SandboxStringTest.TestComplexStream().assertResult(testResult);
        }
    }
    ...
    public static class TestSpliteratorEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.SandboxStringTest.TestSpliterator().assertResult(testResult);
        }
    }
