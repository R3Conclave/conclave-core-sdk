...
public class X500Tests {
    ...
    public static class TestCreateX500PrincipalEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.X500Tests.TestCreateX500Principal().assertResult(testResult);
        }
    }
    ...
    public static class TestX500PrincipalToX500NameEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.X500Tests.TestX500PrincipalToX500Name().assertResult(testResult);
        }
    }
    ...
    public static class TestX500NameToX500PrincipalEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.X500Tests.TestX500NameToX500Principal().assertResult(testResult);
        }
    }
