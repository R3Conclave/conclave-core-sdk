...
import com.r3.conclave.integrationtests.djvm.sandboxtests.util.*;
...
public class AnnotatedJavaClassTest {
    public static class SandboxAnnotationTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public Object apply(Object input) {
            ...
            try {
                sandbox(emptySet(), singleton("com.r3.conclave.integrationtests.djvm.sandboxtests.util.*"), ctx -> {
                    try {
                        ...
                        assertThat(annotationValue.toString())
                                .matches("^\\Q@sandbox.com.r3.conclave.integrationtests.djvm.sandboxtests.util.JavaAnnotation(value=\\E\"?Hello Java!\"?\\)$");
        ...
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.AnnotatedJavaClassTest.SandboxAnnotationTest().assertResult(testResult);
        }
    }
    ...
    public static class AnnotationInsideSandboxTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.AnnotatedJavaClassTest.AnnotationInsideSandboxTest().assertResult(testResult);
        }
    }
    ...
    public static class ReflectionCanFetchAllSandboxedAnnotationsTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public Object apply(Object input) {
            AtomicReference<Object> output = new AtomicReference<>();
            sandbox(emptySet(), singleton("com.r3.conclave.integrationtests.djvm.**"), ctx -> {
                try {
                    Class<?> sandboxClass = loadClass(ctx, UserJavaData.class.getName()).getType();
                    ...
                    assertThat(names).containsExactlyInAnyOrder(
                            "sandbox.com.r3.conclave.integrationtests.djvm.sandboxtests.util.JavaAnnotation"
                    );
                    output.set(names);
                } catch (Throwable throwable) {
                    output.set(Log.recursiveStackTrace(throwable, this.getClass().getCanonicalName()));
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.AnnotatedJavaClassTest.ReflectionCanFetchAllSandboxedAnnotationsTest().assertResult(testResult);
        }
    }
    ...
    public static class ReflectionCanFetchAllMetaAnnotationsTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public Object apply(Object input) {
            ...
            sandbox(ctx -> {
                try {
                    @SuppressWarnings("unchecked")
                    Class<? extends Annotation> sandboxAnnotation
                            = (Class<? extends Annotation>) loadClass(ctx, "com.r3.conclave.integrationtests.djvm.sandboxtests.util.JavaAnnotation").getType();
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.AnnotatedJavaClassTest.ReflectionCanFetchAllMetaAnnotationsTest().assertResult(testResult);
        }
    }
