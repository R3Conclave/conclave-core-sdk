...
import com.r3.conclave.integrationtests.djvm.sandboxtests.proto.ReadingDataTestResult;
...
public class DataInputStreamTest {
    ...
    public static class ReadingDataTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.DataInputStreamTest.ReadingDataTest().assertResult(testResult);
        }
    }
