...
public class JavaTimeTest extends DJVMBase {
    ...
    public static class InstantTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.InstantTest().assertResult(testResult);
        }
    }
    ...
    public static class DurationTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.DurationTest().assertResult(testResult);
        }
    }
    ...
    public static class LocalDateTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.LocalDateTest().assertResult(testResult);
        }
    }
    ...
    public static class LocalTimeTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.LocalTimeTest().assertResult(testResult);
        }
    }
    ...
    public static class LocalDateTimeTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.LocalDateTimeTest().assertResult(testResult);
        }
    }
    ...
    public static class MonthDayTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.MonthDayTest().assertResult(testResult);
        }
    }
    ...
    public static class OffsetDateTimeTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.OffsetDateTimeTest().assertResult(testResult);
        }
    }
    ...
    public static class OffsetTimeTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.OffsetTimeTest().assertResult(testResult);
        }
    }
    ...
    public static class PeriodTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.PeriodTest().assertResult(testResult);
        }
    }
    ...
    public static class YearTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.YearTest().assertResult(testResult);
        }
    }
    ...
    public static class YearMonthTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.YearMonthTest().assertResult(testResult);
        }
    }
    ...
    public static class ZonedDateTimeTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.ZonedDateTimeTest().assertResult(testResult);
        }
    }
    ...
    public static class ZoneOffsetTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.ZoneOffsetTest().assertResult(testResult);
        }
    }
    ...
    public static class AllZoneIDsTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.AllZoneIDsTest().assertResult(testResult);
        }
    }
    ...
    public static class DefaultZoneIDTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.DefaultZoneIDTest().assertResult(testResult);
        }
    }
    ...
    public static class DefaultTimeZoneTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.DefaultTimeZoneTest().assertResult(testResult);
        }
    }
    ...
    public static class DateTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.DateTest().assertResult(testResult);
        }
    }
    ...
    public static class ReturningDateTestEnclaveTest extends DJVMBase implements EnclaveJvmTest {
        ...
        @Override
        public void assertResult(@NotNull byte[] testResult) {
            new com.r3.conclave.integrationtests.djvm.sandboxtests.asserters.JavaTimeTest.ReturningDateTest().assertResult(testResult);
        }
    }
