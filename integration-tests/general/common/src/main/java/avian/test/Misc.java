...
public class Misc {
  ...
  public static void main(String[] args) throws Exception {
    ...
    */
    ...
    // SGX specific properties (see singleton_jvm.cpp)
    expect(System.getProperty("sgx.mode") != null);
    expect(System.getProperty("sgx.mode").equals("hw") || System.getProperty("sgx.mode").equals("sim"));
