...
class EnclaveConstraint {
     ...
     * N.B. that only insecure enclaves are accepted if the security level is set to insecure. This prevents clients
     * from connecting to enclaves running in production by mistake.
     */
