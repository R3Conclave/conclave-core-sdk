...
import avian.test.avian.testing.annotations.Test;
import avian.test.avian.*;
...
public class Reflection {
  ...
  public static void dadada(String x) {        
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    expect(avian.test.avian.TestReflection.get(Baz.class.getField("foo"), new Baz())
           .equals(42));
    ...
    expect(Test.class.getPackage().getName().equals
    ...
    {
        Method m = Reflection.class.getMethod("dadada", String.class);
