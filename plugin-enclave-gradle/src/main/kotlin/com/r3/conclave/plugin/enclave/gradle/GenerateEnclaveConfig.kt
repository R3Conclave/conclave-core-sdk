...
open class GenerateEnclaveConfig @Inject constructor(
    ...
    override fun action() {
        ...
        val maxHeapSizeBytes = conclaveExtension.maxHeapSize.get().let {
            when {
