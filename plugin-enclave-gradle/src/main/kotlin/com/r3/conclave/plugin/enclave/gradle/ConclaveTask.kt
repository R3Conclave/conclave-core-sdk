...
abstract class ConclaveTask : DefaultTask() {
    ...
    fun commandLine(vararg command: String): ExecResult = commandLine(command.asList())

    fun commandLine(command: List<String>, commandLineConfig: CommandLineConfig = CommandLineConfig()): ExecResult {
    ...
    fun commandWithOutput(vararg command: String): String {
