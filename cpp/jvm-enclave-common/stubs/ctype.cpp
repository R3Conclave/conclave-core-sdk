...
int main() {
    ...
    const unsigned short int* arr2 = *__ctype_b_loc();    
    printf("static const unsigned short int __b_loc[] = {");
    for (int i = 0; i < 384; ++i) {
        if ((i % 8) == 0) {
            printf("\n    ");
        }
        printf("0x%X%s", arr2[i], (i != 383) ? ", " : "");
    }
    printf("\n};\n");
...
static const unsigned short int __b_loc[] = {
    ...
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 
    0x20, 0x0, 0x0, 0x0, 0x0, 0x0, 0x28, 0x0, 
    0x43, 0x0, 0x29, 0x0, 0x0, 0x0, 0x0, 0x0, 
    0x3C, 0x0, 0x3C, 0x0, 0x0, 0x0, 0x0, 0x0, 
    0x2D, 0x0, 0x0, 0x0, 0x0, 0x0, 0x28, 0x0, 
    0x52, 0x0, 0x29, 0x0, 0x0, 0x0, 0x0, 0x0, 
    0x75, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2C, 0x0, 
    0x0, 0x0, 0x0, 0x0, 0x3E, 0x0, 0x3E, 0x0, 
    0x0, 0x0, 0x0, 0x0, 0x20, 0x0, 0x31, 0x0, 
    0x2F, 0x0, 0x34, 0x0, 0x20, 0x0, 0x0, 0x0, 
    0x0, 0x0, 0x20, 0x0, 0x31, 0x0, 0x2F, 0x0, 
    0x32, 0x0, 0x20, 0x0, 0x0, 0x0, 0x0, 0x0, 
    0x20, 0x0, 0x33, 0x0, 0x2F, 0x0, 0x34, 0x0, 
    0x20, 0x0, 0x0, 0x0, 0x0, 0x0, 0x41, 0x0, 
    0x45, 0x0, 0x0, 0x0, 0x0, 0x0, 0x78, 0x0, 
    0x0, 0x0, 0x0, 0x0, 0x73, 0x0, 0x73, 0x0, 
    0x0, 0x0, 0x0, 0x0, 0x61, 0x0, 0x65, 0x0
};

static const unsigned short *const p__b_loc = __b_loc;
static const uint32_t *const p__toupper_loc = __toupper_loc;

extern "C" {

const unsigned short **__ctype_b_loc(void) {
	return (const short unsigned int**)&p__b_loc;
}
