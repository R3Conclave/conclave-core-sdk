...
#include <jni.h>
/* Header for class com_r3_conclave_core_enclave_internal_Native */

#ifndef _Included_com_r3_conclave_core_enclave_internal_Native
#define _Included_com_r3_conclave_core_enclave_internal_Native
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_r3_conclave_core_enclave_internal_Native
