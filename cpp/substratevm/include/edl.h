...
extern "C" {
#endif
void Java_com_r3_conclave_enclave_internal_substratevm_EntryPoint_entryPoint(graal_isolatethread_t*, short, char, char*, int);
void Java_com_r3_conclave_enclave_internal_substratevm_EntryPoint_internalError(graal_isolatethread_t*, char*, int);

void jvm_ecall(short callTypeID, char messageTypeID, void* bufferIn, int bufferSize);
