/*
 * This file is usually generated by native-image as part of the build process of an application.
 * It is also generated by the build process of Graal itself.
 * It describes the interface to instantiate isolates, which is needed by the EDL layer.
 * Since the EDL layer is a library passed to native-image to complete the link process,
 * there is a circular dependency. As such, this file has been picked up from the Graal
 * build files and made part of the substrate library.
 * This interface might change between Graal versions.
 */
