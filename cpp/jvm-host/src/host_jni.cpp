...
JNIEXPORT jint JNICALL Java_com_r3_sgx_core_host_internal_Native_getDeviceStatus
        (JNIEnv *, jobject) {
#ifdef SGX_SIM
...
jlong JNICALL Java_com_r3_sgx_core_host_internal_Native_createEnclave
...
void JNICALL Java_com_r3_sgx_core_host_internal_Native_destroyEnclave
...
void JNICALL Java_com_r3_sgx_core_host_internal_Native_jvmEcall
...
JNIEXPORT void JNICALL Java_com_r3_sgx_core_host_internal_Native_initQuote
...
JNIEXPORT jint JNICALL Java_com_r3_sgx_core_host_internal_Native_calcQuoteSize
...
JNIEXPORT void JNICALL Java_com_r3_sgx_core_host_internal_Native_getQuote
...
JNIEXPORT void JNICALL Java_com_r3_sgx_core_host_internal_Native_getMetadata
...
void jvm_ocall(void* bufferIn, int bufferInLen) {
    ...
    try {
        ...
        checkJniException(jniEnv);
        auto hostEnclaveApiClass = jniEnv->FindClass("com/r3/sgx/core/host/internal/NativeApi");
        checkJniException(jniEnv);
