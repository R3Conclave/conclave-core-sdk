...
class GramineEnclaveHandle(
    ...
    override fun initialise(attestationParameters: AttestationParameters?) {
        ...
        // Any output generated by the enclave is discarded when running in release mode but the developer
        // can override this functionality.
        // Turn off the enclave process redirect to the host when running in release mode.
        // It's not fully secure, but it avoids issues if the user is using Conclave as-is and
        // overrides redirection of the output generated by the enclave to the console.
